    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>TeamMembers</p>
            <CardBox
            ...
            >
                ...
                <table>
                  ...
                  <tbody>
                    {departments.team_members &&
                      Array.isArray(departments.team_members) &&
                      departments.team_members.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
              ...
              {!departments?.team_members?.length && (
