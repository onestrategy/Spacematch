    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Leads AssignedTo</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.leads_assigned_to &&
                      Array.isArray(users.leads_assigned_to) &&
                      users.leads_assigned_to.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
              ...
              {!users?.leads_assigned_to?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
